...
;(function (root, factory) {
    if (typeof define === 'function' && define.amd) {
        ...
        TableExport.prototype = {
            ...
            xls: {
                defaultClass: "xls",
                buttonContent: '<i class="fa fa-file-excel-o" aria-hidden="true"></i> Export <strong>xls</strong>',
                separator: "\t",
            ...
            csv: {
                defaultClass: "csv",
                buttonContent: '<i class="fa fa-file-excel-o" aria-hidden="true"></i> Export <strong>csv</strong>',
                separator: ",",
